#!/usr/bin/env python3
"""
Main entry point for the Real-Time Network Intrusion Detection System.
"""
...
Examples:
  ...
  python main.py --pcap traffic.pcap --offline
  ...
  python main.py --demo --duration 60
    ...
    if not config_file.exists():
        ...
        logger.info("Create a configuration file or run: python scripts/demo.py --help")
        return 1
    ...
    try:
        ...
        logger.info("NIDS shutdown complete")
        return 0
        
    except Exception as e:
        logger.error(f"NIDS failed: {e}")
        if args.verbose:
            import traceback
            traceback.print_exc()
        return 1
